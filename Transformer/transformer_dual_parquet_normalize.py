...
class MagicDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        x_m1 = (x_m1 - x_m1.mean()) / (x_m1.std() + 1e-8)
        x_m2 = (x_m2 - x_m2.mean()) / (x_m2.std() + 1e-8)
...
if __name__ == "__main__":
    ...
    for epoch in range(EPOCHS):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), "best_model_dual_normalized.pt")

    torch.save(model.state_dict(), "best_model_dual_normalized_fin.pt")
