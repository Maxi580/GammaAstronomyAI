...
def create_model_with_params(trial):
    return CustomHexCNN(
        ...
        linear1_size=trial.suggest_int('linear1_size', 512, 38400, step=256, log=True),
        linear2_size=trial.suggest_int('linear2_size', 128, 5096, step=64, log=True),
        linear3_size=trial.suggest_int('linear3_size', 32, 2048, step=32, log=True),
